\doxysection{/home/honeyguide/\+Desktop/\+My\+Open\+Source/facad/src/git\+\_\+utils.c File Reference}
\hypertarget{git__utils_8c}{}\label{git__utils_8c}\index{/home/honeyguide/Desktop/MyOpenSource/facad/src/git\_utils.c@{/home/honeyguide/Desktop/MyOpenSource/facad/src/git\_utils.c}}
...
Include dependency graph for git\+\_\+utils.\+c\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{df/d71/git__utils_8c__incl}
\end{center}
\end{figure}
\doxysubsubsection*{Functions}
\begin{DoxyCompactItemize}
\item 
bool \mbox{\hyperlink{git__utils_8c_a51ae0134feff92edfd5cf268cd0b1acf}{is\+\_\+git\+\_\+repository}} ()
\begin{DoxyCompactList}\small\item\em Checks if the current directory is part of a Git repository. \end{DoxyCompactList}\item 
static char \mbox{\hyperlink{git__utils_8c_aa639b9b3bbea0da0a09fbad3ca69aa5d}{parse\+\_\+status}} (const char \texorpdfstring{$\ast$}{*}status\+\_\+str)
\begin{DoxyCompactList}\small\item\em Parses a Git status string and returns a single character status code. \end{DoxyCompactList}\item 
\mbox{\hyperlink{structGitFileList}{Git\+File\+List}} \mbox{\hyperlink{git__utils_8c_a1af8df0b83d4e26524cdb4371b7bd7a6}{get\+\_\+git\+\_\+status}} ()
...
char \texorpdfstring{$\ast$}{*} \mbox{\hyperlink{git__utils_8c_a2ef1d42e63a1b1ab2270c1d82157a384}{get\+\_\+current\+\_\+branch}} ()
...
Definition in file \mbox{\hyperlink{git__utils_8c_source}{git\+\_\+utils.\+c}}.



\doxysubsection{Function Documentation}
\Hypertarget{git__utils_8c_a2ef1d42e63a1b1ab2270c1d82157a384}\label{git__utils_8c_a2ef1d42e63a1b1ab2270c1d82157a384} 
\index{git\_utils.c@{git\_utils.c}!get\_current\_branch@{get\_current\_branch}}
\index{get\_current\_branch@{get\_current\_branch}!git\_utils.c@{git\_utils.c}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{d1/db9/git__utils_8c_a2ef1d42e63a1b1ab2270c1d82157a384_icgraph}
\end{center}
\end{figure}
\Hypertarget{git__utils_8c_a1af8df0b83d4e26524cdb4371b7bd7a6}\label{git__utils_8c_a1af8df0b83d4e26524cdb4371b7bd7a6} 
\index{git\_utils.c@{git\_utils.c}!get\_git\_status@{get\_git\_status}}
\index{get\_git\_status@{get\_git\_status}!git\_utils.c@{git\_utils.c}}
...
\begin{center}
\leavevmode
\includegraphics[width=279pt]{d1/db9/git__utils_8c_a1af8df0b83d4e26524cdb4371b7bd7a6_cgraph}
\end{center}
\end{figure}
Here is the caller graph for this function\+:
\nopagebreak
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{d1/db9/git__utils_8c_a1af8df0b83d4e26524cdb4371b7bd7a6_icgraph}
\end{center}
\end{figure}
\Hypertarget{git__utils_8c_a51ae0134feff92edfd5cf268cd0b1acf}\label{git__utils_8c_a51ae0134feff92edfd5cf268cd0b1acf} 
\index{git\_utils.c@{git\_utils.c}!is\_git\_repository@{is\_git\_repository}}
\index{is\_git\_repository@{is\_git\_repository}!git\_utils.c@{git\_utils.c}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{d1/db9/git__utils_8c_a51ae0134feff92edfd5cf268cd0b1acf_icgraph}
\end{center}
\end{figure}
\Hypertarget{git__utils_8c_aa639b9b3bbea0da0a09fbad3ca69aa5d}\label{git__utils_8c_aa639b9b3bbea0da0a09fbad3ca69aa5d} 
\index{git\_utils.c@{git\_utils.c}!parse\_status@{parse\_status}}
\index{parse\_status@{parse\_status}!git\_utils.c@{git\_utils.c}}
\doxysubsubsection{\texorpdfstring{parse\_status()}{parse\_status()}}
{\footnotesize\ttfamily static char parse\+\_\+status (\begin{DoxyParamCaption}\item[{const char \texorpdfstring{$\ast$}{*}}]{status\+\_\+str }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [static]}}



Parses a Git status string and returns a single character status code. 

This function interprets the two-\/character Git status string and returns a single character representing the file\textquotesingle{}s status.


\begin{DoxyParams}{Parameters}
{\em status\+\_\+str} & Two-\/character Git status string. \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Single character representing the file\textquotesingle{}s Git status. 
\end{DoxyReturn}


Definition at line \mbox{\hyperlink{git__utils_8c_source_l00051}{51}} of file \mbox{\hyperlink{git__utils_8c_source}{git\+\_\+utils.\+c}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{00051\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \{}
\DoxyCodeLine{00052\ \ \ \ \ \textcolor{keywordflow}{if}\ (status\_str[0]\ ==\ \textcolor{charliteral}{'?'}\ \&\&\ status\_str[1]\ ==\ \textcolor{charliteral}{'?'})\ \textcolor{keywordflow}{return}\ \textcolor{charliteral}{'U'};\ \ \textcolor{comment}{//\ Untracked}}
\DoxyCodeLine{00053\ \ \ \ \ \textcolor{keywordflow}{if}\ (status\_str[0]\ ==\ \textcolor{charliteral}{'!'}\ \&\&\ status\_str[1]\ ==\ \textcolor{charliteral}{'!'})\ \textcolor{keywordflow}{return}\ \textcolor{charliteral}{'I'};\ \ \textcolor{comment}{//\ Ignored}}
\DoxyCodeLine{00054\ \ \ \ \ \textcolor{keywordflow}{return}\ status\_str[0]\ !=\ \textcolor{charliteral}{'\ '}\ ?\ status\_str[0]\ :\ status\_str[1];\ \ \ \textcolor{comment}{//\ Modified,\ Staged,\ etc.}}
\DoxyCodeLine{00055\ \}}

\end{DoxyCode}


Referenced by \mbox{\hyperlink{git__utils_8c_source_l00065}{get\+\_\+git\+\_\+status()}}.
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{d1/db9/git__utils_8c_aa639b9b3bbea0da0a09fbad3ca69aa5d_icgraph}
\end{center}
\end{figure}
