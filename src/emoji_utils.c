    ...
    if (extension) {
        ...
        static const EmojiMapEntry ext_map[] = {
            ...
            {"app", "📱"},    {"dmg", "💿"},     {"pkg", "📦"},   {"patch", "🩹"},
						...
						{"sks", "🎮"},    {"car", "🚗"},     {"xcassets", "🗂️"},
						{"dSYM", "🐛"},   {"terminal", "🖥️"},{"lock", "🔒"},
						{"webloc", "🔗"}, {"workflow", "🔄"},{"apk", "📱"},   {"rc", "👟"},
            ...
            {"ipa", "📲"},    {"xcodeproj", "🛠️"}, {"mlmodel", "🤖"}, 
						{"icns", "🖼️"},   {"framework", "🏗️"}, {"xcassets", "🗂️"},
            {"playground", "🎠"}, {"part", "🧩"}, {"diff", "🆚"}, {"bak", "🔙"}, {"cache", "⏱️"},
            {"desktop", "🖥️"}, {"cron", "📅"}, {"env", "🌍"}, {"bin", "💾"}, {"pid", "🪪"}, {"swap", "🔄"}
				};
