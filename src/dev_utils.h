...
extern "C"
{
    ...
    /**
     * Handles the contents of the /dev directory and fills an array of FileEntry records.
     *
     * @param entries Double pointer to an array of FileEntry structures that will be populated.
